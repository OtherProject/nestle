/*! jQuery Mobile 1.4.3 | Git HEADhash: b9c6473 <> 2014-07-01T15:37:36Z | (c) 2010, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function(a, b, c) {
    ...
    function(a, b) {
        function d(b, c) {
            ...
            return "area" === h ? (d = b.parentNode, f = d.name, b.href && f && "map" === d.nodeName.toLowerCase() ? (g = a("img[usemap=#" + f + "]")[0], !!g && e(g)) : !1) : (/input|textarea|button|object/.test(h) ? !b.disabled : "a" === h ? b.href || c : c) && e(b)
        }
        ...
        a.widget("mobile.pagecontainer", {
            ...
            transition: function(b, g, h) {
                ...
                if (this._triggerPageBeforeChange(b, g, h) && (g.prevPage = h.fromPage, v = this._triggerWithDeprecated("beforetransition", g), !v.deprecatedEvent.isDefaultPrevented() && !v.event.isDefaultPrevented())) {
                    ...
                    try {
                        c.activeElement && "body" !== c.activeElement.nodeName.toLowerCase() ? a(c.activeElement).blur() : a("input:focus, textarea:focus").blur()
                    } catch (w) {}
    ...
    function(a, b) {
        ...
        a.widget("mobile.checkboxradio", a.extend({
            initSelector: "input:not( :jqmData(role='flipswitch' ) )input[type='radio']:not( :jqmData(role='flipswitch' ))",
            options: {
                theme: "inherit",
                mini: !1,
                wrapperClass: null,
